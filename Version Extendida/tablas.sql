...
CREATE TABLE IF NOT EXISTS seg_dispositivo(
	id_seguridad integer,
	id_dispositivo integer, 
	primary key (id_seguridad, id_dispositivo),
    foreign key (id_seguridad) references seguridad,
    foreign key (id_dispositivo) references dispositivo
);

CREATE TABLE IF NOT EXISTS soluciones_des(
	id_solucion serial,
    tipo_solucion varchar(40), 
	primary key (id_solucion)
);

CREATE TABLE IF NOT EXISTS soluciones_op(
	id_solucion serial,
    tipo_solucion varchar(40), 
	primary key (id_solucion)
);

CREATE TABLE IF NOT EXISTS op_sol(
	id_operaciones integer,
	id_solucion integer, 
	primary key (id_operaciones, id_solucion),
    foreign key (id_operaciones) references operaciones,
    foreign key (id_solucion) references soluciones_op
);

CREATE TABLE IF NOT EXISTS des_sol(
	id_desarrollo integer,
	id_solucion integer, 
	primary key (id_desarrollo, id_solucion),
    foreign key (id_desarrollo) references desarrollo,
    foreign key (id_solucion) references soluciones_des
);
...
INSERT INTO casos_seguridad (nombre_caso) VALUES ('Cantidad de dispositivos en riesgo');
...
INSERT INTO dispositivo (nombre_dispositivo) VALUES ('Laptop');
INSERT INTO dispositivo (nombre_dispositivo) VALUES ('Desktop');
INSERT INTO dispositivo (nombre_dispositivo) VALUES ('Servidores');

INSERT INTO soluciones_des (tipo_solucion) VALUES ('Configuracion');
INSERT INTO soluciones_des (tipo_solucion) VALUES ('Entrenamiento');
INSERT INTO soluciones_des (tipo_solucion) VALUES ('Desarrollo');
INSERT INTO soluciones_des (tipo_solucion) VALUES ('Procedimental');
INSERT INTO soluciones_des (tipo_solucion) VALUES ('Infraestructura');

INSERT INTO soluciones_op (tipo_solucion) VALUES ('Default');
INSERT INTO soluciones_op (tipo_solucion) VALUES ('Incidente');
INSERT INTO soluciones_op (tipo_solucion) VALUES ('Requerimiento');
